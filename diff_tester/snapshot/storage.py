...
class SnapshotManager:
    ...
    def store_snapshot(self, 
        ...
        snapshot_path = (self.snapshot_dir / module_path / benchmark_name / 
                        f"{param_hash}.pkl")
        ...
        try:
            ...
            if hasattr(value, '__dict__'):
                ...
                try:
                    ...
                    serialized_dict = {
                        '__dict_error__': f"Cannot serialize __dict__: {dict_error}"
                    }
    ...
    def load_snapshot(self, 
                     benchmark_name: str,
                     module_path: str,
                     parameters: Tuple[Any, ...]) -> Optional[Tuple[Any, SnapshotMetadata]]:
    ...
    def list_snapshots(self, 
                      ...
                      benchmark_name: Optional[str] = None) -> List[Tuple[Path, SnapshotMetadata]]:
