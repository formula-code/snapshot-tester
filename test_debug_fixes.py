...
def test_simple_benchmark():
    ...
    for benchmark in benchmarks:
        if (benchmark.benchmark_type == 'function' and 
            benchmark.module_path == 'coordinates' and
            benchmark.name in ['time_latitude', 'time_angle_array_repr', 'time_angle_array_str', 'time_angle_array_repr_latex']):
...
def test_parameterized_benchmark():
    ...
    for benchmark in benchmarks:
        if (benchmark.benchmark_type == 'method' and 
            benchmark.params and
            benchmark.module_path == 'convolve'):
